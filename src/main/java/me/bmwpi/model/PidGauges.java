...
public class PidGauges {
    ...
    private static final int GAUGE_SIZE = Settings.getGaugeSize();
    public static Gauge getRpmGauge() {
        return GaugeBuilder.create().title("Engine RPM").prefSize(GAUGE_SIZE,GAUGE_SIZE).skinType(Gauge.SkinType.GAUGE)
    ...
    public static Gauge getCoolantTempGauge() {
        return GaugeBuilder.create().title("Coolant Temp").unit("ºC").prefSize(GAUGE_SIZE,GAUGE_SIZE).skinType(Gauge.SkinType.GAUGE)
    ...
    public static Gauge getBoostGauge() {
        return GaugeBuilder.create().title("Boost").unit("bar").prefSize(GAUGE_SIZE,GAUGE_SIZE).skinType(Gauge.SkinType.GAUGE)
    ...
    public static Gauge getOilTempGauge() {
        return GaugeBuilder.create().title("Oil Temp").unit("ºC").prefSize(GAUGE_SIZE,GAUGE_SIZE).skinType(Gauge.SkinType.GAUGE)
                .animated(true).animationDuration(ANIM_DURATION).maxValue(200).tickMarkSectionsVisible(true).minorTickMarksVisible(true).mediumTickMarksVisible(false)
                .majorTickSpace(40).majorTickMarkType(TickMarkType.BOX).customTickLabelsEnabled(true).customTickLabels("0","","40","","80","","120","","160","","200")
                .tickLabelColor(Color.rgb(0, 204, 255)).customTickLabelFontSize(40).majorTickMarkWidthFactor(20)
                .backgroundPaint(Color.rgb(10,10,10))
    ...
    public static Gauge getIntakeTempGauge() {
        return GaugeBuilder.create().title("Intake Air Temp").unit("ºC").prefSize(GAUGE_SIZE,GAUGE_SIZE).skinType(Gauge.SkinType.GAUGE)
    ...
    public static Gauge getEngineLoadGauge() {
        return GaugeBuilder.create().title("Engine Load").unit("%").prefSize(GAUGE_SIZE,GAUGE_SIZE).skinType(Gauge.SkinType.GAUGE)
                ...
                .majorTickMarkType(TickMarkType.BOX).customTickLabelsEnabled(true).customTickLabels("0","","20","","40","","60","","80","","100")
                .tickLabelColor(Color.rgb(0, 204, 255)).customTickLabelFontSize(40).majorTickMarkWidthFactor(20)
                .backgroundPaint(Color.rgb(10,10,10))
    ...
    public static Gauge getAirflowRateGauge() {
        return GaugeBuilder.create().title("Air Flow Rate").unit("g/s").prefSize(GAUGE_SIZE,GAUGE_SIZE).skinType(Gauge.SkinType.GAUGE)
    ...
    public static Gauge getTorqueGauge() {
        return GaugeBuilder.create().title("Engine Torque").unit("%").prefSize(GAUGE_SIZE,GAUGE_SIZE).skinType(Gauge.SkinType.GAUGE)
                .animated(true).animationDuration(ANIM_DURATION).maxValue(100).tickMarkSectionsVisible(true).minorTickMarksVisible(true).mediumTickMarksVisible(false)
                .majorTickMarkType(TickMarkType.BOX).customTickLabelsEnabled(true).customTickLabels("0","","20","","40","","60","","80","","100")
                .tickLabelColor(Color.rgb(0, 204, 255)).customTickLabelFontSize(40).majorTickMarkWidthFactor(20)
                .backgroundPaint(Color.rgb(10,10,10))
    ...
    public static Gauge getSpeedGauge() {
        return GaugeBuilder.create().title("Speed").unit("km/h").prefSize(GAUGE_SIZE,GAUGE_SIZE).skinType(Gauge.SkinType.GAUGE)
                .animated(true).animationDuration(ANIM_DURATION).maxValue(200).tickMarkSectionsVisible(true).minorTickMarksVisible(true).mediumTickMarksVisible(false)
                .majorTickSpace(40).majorTickMarkType(TickMarkType.BOX).customTickLabelsEnabled(true).customTickLabels("0","","40","","80","","120","","160","","200")
                .tickLabelColor(Color.rgb(0, 204, 255)).customTickLabelFontSize(40).majorTickMarkWidthFactor(20)
                .backgroundPaint(Color.rgb(10,10,10))
